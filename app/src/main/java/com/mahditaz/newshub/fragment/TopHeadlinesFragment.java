...
import com.mahditaz.newshub.databinding.FragmentTopHeadlinesBinding;
import com.mahditaz.newshub.util.ArticleComparator;
import com.mahditaz.newshub.util.Utils;
import com.mahditaz.newshub.viewmodel.TopHeadlinesViewModel;
...
public class TopHeadlinesFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(TopHeadlinesViewModel.class);
    ...
    private void initRVandAdapter(){
        ...
        binding.thRV.setLayoutManager(gridLayoutManager);
        binding.thRV.setAdapter(adapter.withLoadStateFooter(
